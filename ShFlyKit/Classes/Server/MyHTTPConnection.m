...
const NSString *kUploadFileNotificationName = @"kUploadFileNotificationName";
...
- (void) processStartOfPartWithHeader:(MultipartMessageHeader*) header {
    ...
    if( [[NSFileManager defaultManager] fileExistsAtPath:filePath] ) {
        ...
        NSString *uploadName = [NSString stringWithFormat:@"/upload/%@", filename];
		[uploadedFiles addObject: uploadName];
        //收到文件
        [[NSNotificationCenter defaultCenter]postNotificationName:@"" object:nil userInfo:@{@"name":uploadName,@"path":filePath}];
    }
}
