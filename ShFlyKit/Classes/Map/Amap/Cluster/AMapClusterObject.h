...
@property(nonatomic,assign)CLLocationCoordinate2D coordinate;           //对应坐标点
@property(nonatomic,assign)NSInteger count;                             //对应点数
@property(nonatomic,strong)NSMutableArray *pois;                        //对应位置数组
...
///点集合数据模型
@interface AMapClusterModel : NSObject
