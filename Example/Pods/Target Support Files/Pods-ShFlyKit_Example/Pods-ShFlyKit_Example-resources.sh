...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../ShFlyKit/Assets/line.plist"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ShFlyKit/Graphics.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ShFlyKit/Map.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ShFlyKit/Share.bundle"
fi
