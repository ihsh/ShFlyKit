...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../ShFlyKit/Classes/Map/BaiduMap/SDKs/BaiduMapAPI_Map.framework/mapapi.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ShFlyKit/BaiduMap.bundle"
